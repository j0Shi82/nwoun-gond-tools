...
<div class="{classes.div1} border-red-700">
    ...
    <div class="{classes.div3}">
        <a href="https://www.patreon.com/nwoun" target="_blank">{ $localize('auction.engine.down.help') }</a>
    </div>
</div>
{/if}
</div>
...
<div class="{classes.div1} border-gray-700 mb-2">
    ...
    <div class="{classes.div3}">
        <a href="https://www.patreon.com/nwoun" target="_blank">{ $localize('auction.engine.loading.help') }</a>
    </div>
</div>
{/if}